...
(CLI, future teaching application, third-party integrations) keep
...
testing with Hypothesis~\cite{hypothesis-docs} is well suited to it.
...
\begin{table}[ht]
  ...
  \begin{tabular}{l r r}
    ...
    \bottomrule
  \end{tabular}
  \caption{Coverage at the close of Sprint~3 (244 tests passing).}
  \label{tab:coverage}
\end{table}
...
\begin{table}[ht]
  ...
  \begin{tabular}{p{0.20\linewidth} p{0.23\linewidth} p{0.23\linewidth} p{0.25\linewidth}}
    ...
    Limited. &
    Limited. &
    244 tests, $>$95\% coverage on the core. \\
    Distribution &
