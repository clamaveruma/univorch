% Resumen en español. La normativa de la EI UMA pide 150-300 palabras y
% entre 3 y 5 palabras clave. Este es un borrador con la idea
% argumental; revisar y comprimir cuando los capítulos estén estables.
\renewcommand{\abstractname}{Resumen}
\begin{abstract}
% TODO redactar y ajustar a 150-300 palabras.
Este Trabajo Fin de Grado presenta una \emph{prueba de concepto} de un
